...
func (lp *Loadpoint) SetGeofenceEnabled(enabled bool) {
	...
	lp.log.DEBUG.Printf("set geofence enabled: %v", enabled)
...
func (lp *Loadpoint) SetGeofenceLat(lat float64) {
	...
	lp.log.DEBUG.Printf("set geofence latitude: %.4f", lat)
...
func (lp *Loadpoint) SetGeofenceLon(lon float64) {
	...
	lp.log.DEBUG.Printf("set geofence longitude: %.4f", lon)
...
func (lp *Loadpoint) SetGeofenceRadius(radius float64) {
	...
	lp.log.DEBUG.Printf("set geofence radius: %v", radius)
